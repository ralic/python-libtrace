...
for b in ba: print("%02x " % b, end=' ')
print()

print("short[2] = %04x" % nk.ba_get_short(ba,2), end=' ')
print("short[4] = %04x" % nk.ba_get_short(ba,4), end=' ')
print("long[2]  = %08x" % nk.ba_get_long(ba,2), end=' ')
print("long[5]  = %s\n" % nk.ba_get_long(ba,5))
